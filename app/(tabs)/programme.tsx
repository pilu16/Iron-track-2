        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalBox}>
            ...
            <Text style={styles.modalBody}>
              {`"${program.name.toUpperCase()}"`} sera supprimé définitivement. Les séances du journal ne seront plus affichées.
            </Text>
            <TouchableOpacity
              ...
              activeOpacity={0.8}
            >
              <Text style={styles.modalBtnDangerText}>SUPPRIMER DÉFINITIVEMENT</Text>
            </TouchableOpacity>
            <TouchableOpacity
...
const styles = StyleSheet.create({
  ...
  modalBody: { fontFamily: FONT_MONO, fontSize: 11, color: TEXT_SECONDARY, letterSpacing: 1, lineHeight: 18 },
  modalBtnDanger: {
    backgroundColor: HAZARD, paddingVertical: 14, alignItems: 'center',
  },
  modalBtnDangerText: { fontFamily: FONT_MONO_BOLD, fontSize: 12, color: '#FFFFFF', letterSpacing: 2 },
  modalBtnCancel: {
    borderWidth: 1, borderColor: BORDER, paddingVertical: 14, alignItems: 'center',
  },
